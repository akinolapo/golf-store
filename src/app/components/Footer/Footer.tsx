        ...
        <footer className="bg-gray-100 text-gray-700">
            <div className="container mx-auto px-6 py-8 flex flex-col lg:flex-row justify-between items-center">
                <div className="lg:w-1/3 mb-6 lg:mb-0">
                    <h2 className="text-xl font-bold">Safira</h2>
                    <p className="mt-2">We are a team of designers and developers that create high quality Magento.</p>
                    <div className="mt-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <ul className="mt-2">
                                ...
                                <li><a href="#" className="hover:underline">Gift Certificates</a></li>
                ...
                <div className="lg:w-1/3">
                    ...
                    <p className="mt-2">Sign up for our e-mail to get latest news.</p>
                    <div className="mt-4 flex">
                        <input type="email" placeholder="Your email letter" className="p-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        <button className="p-2 bg-gray-800 text-white rounded-r-md hover:bg-gray-900">Subscribe</button>
                    </div>
                </div>
            </div>
            <div className="bg-gray-200 text-center py-4">
                <p className="text-sm">&copy; 2024 Safira. All rights reserved</p>
                <div className="mt-2 flex justify-center space-x-4">
                    <Image src="/payment.png" alt="Payment method" width={300} height={150}/>
                </div>
            </div>
        </footer>
    );
