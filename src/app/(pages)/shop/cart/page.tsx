        ...
        {cartItems.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            ...
            <div className="flex items-center justify-between mt-4">
              <div>
                <button onClick={handleClearCart} className="bg-red-500 text-white px-4 py-2 rounded mb-2 lg:mb-0">
                  Clear Cart
                </button>
              </div>
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between mt-4 gap-4">
              <Link href="/shop" className="bg-gray-500 text-white px-4 py-2 rounded mb-2 text-center">
                Continue Shopping
              </Link>
              <Link href="/shop/cart/checkout" className="bg-green-500 text-white px-4 py-2 rounded text-center">
                Proceed to Checkout
              </Link>
            </div>
          </div>
